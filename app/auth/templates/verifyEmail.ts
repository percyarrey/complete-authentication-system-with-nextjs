const verifyEmailTemplate = `<!-- app/auth/templates/verifyEmail.html -->
<!DOCTYPE html>
<html lang="en">
  <head>
    <meta charset="UTF-8" />
    <meta name="viewport" content="width=device-width, initial-scale=1.0" />
    <title>Verify Your Email for {{website}}!</title>
    <style>
      body {
  ...
  <body>
    <div class="container">
      ...
      <div class="content">
        ...
        <p>
          Thank you for signing up for {{website}}! To complete your
          registration, please verify your email address using the code below:
        </p>
